...
git clone https://github.com/Zhefan-Xu/xgc2_cerlab_uav_simulator.git
...
```
source path/to/xgc2_cerlab_uav_simulator/gazeboSetup.bash
```
...
```
roslaunch xgc2_cerlab_uav_simulator start.launch
```

You should be able to see a customized quadcopter in a predefined gazebo environment as shown below: 

![simulator](https://github.com/Zhefan-Xu/xgc2_cerlab_uav_simulator/assets/55560905/32f1a2d1-becb-4854-b6e1-161118b319f4)


b. To launch the PX4 simulator with a quadcopter:
```
roslaunch xgc2_cerlab_uav_simulator px4_start.launch
```

You should be able to see a PX4 IRIS quadcopter in a predefined gazebo environment as shown below: 

![px4_simulator](https://github.com/Zhefan-Xu/xgc2_cerlab_uav_simulator/assets/55560905/fbcb0100-51cf-445a-bfa0-25dc96ab022e)
...
![keboard_control](https://github.com/Zhefan-Xu/xgc2_cerlab_uav_simulator/assets/55560905/989fd8eb-28d6-4927-a021-2b191765ed82)
...
![Screenshot from 2023-12-18 20-36-34](https://github.com/Zhefan-Xu/xgc2_cerlab_uav_simulator/assets/55560905/4792edb1-1920-4097-b5aa-b8be64fe7b4e)
...
cd xgc2_cerlab_uav_simulator/scripts
